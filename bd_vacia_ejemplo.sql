...
INSERT INTO `options` (`id`, `name`, `value`, `extra_value`) VALUES (NULL, 'refresh-token', '', '');
INSERT INTO `options` (`id`, `name`, `value`, `extra_value`) VALUES (NULL, 'simbolos_panel_general', '', '');
INSERT INTO `options` (`id`, `name`, `value`, `extra_value`) VALUES (NULL, 'simbolos_panel_cedears', '', '');